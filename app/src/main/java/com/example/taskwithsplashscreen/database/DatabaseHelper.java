package com.example.taskwithsplashscreen.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " +Constants.TABLE_NAME+ "(NAME TEXT,PHONE INTEGER(10), EMAIL TEXT primary key,PASSWORD TEXT  ,ADDRESS TEXT, CITY TEXT,GENDER INTEGER)");
...
//        //Cursor cursor=db.rawQuery ( "Select * from "+Constants.TABLE_NAME+" where (email="+email);
//    }

    public boolean insertData(String name, String phone, String email,String password, String address,String city , String gender ){
        ...
        contentValues.put ( Constants.PASSWORD_COLUMN,password );
...
//        return result != -1;
//    }
    public boolean insertFinal(String USER_ID,String HOBBIES_ID){
